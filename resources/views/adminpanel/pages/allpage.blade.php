...
@section('header','Все страници')
@section('content')
    <div class="col-sm-12">
        <section class="panel panel-default">
            <form id="all-post-form" action="{{ route('to_trash_chose_page') }}" method="POST">
                {!! csrf_field() !!}
            ...
            <div class="row wrapper">
                ...
                <div class="col-sm-5 m-b-xs">
                    <a href="{{ route('trash_page_view') }}" class="btn btn-sm btn-default"><i class="i i-trashcan"></i> Корзина</a>
                </div>
            </div>
                        ...
                        <td>
                            ...
                            <div>
                                <ul class="row-property">
                                    ...
                                    <li><a href="#page_del_{{$page->page_id}}" class="page_del_link del-link">В корзину</a></li>
                                    <li><a href="{{ route('page',array('page_slug'=>$page->page_slug)) }}">Просмотреть</a></li>
                                </ul>
                            </div>
    ...
    @foreach($pages as $page)
        <form method="POST" id="page_del_{{$page->page_id}}" action="{{ route('to_trash_page',['page_id' => $page->page_id]) }}" accept-charset="UTF-8" style="display: none;" >
