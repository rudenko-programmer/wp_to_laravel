...
if (false) {(function () {  module.hot.accept()
  ...
  var id = "C:\\OpenServer\\domains\\rabota-x\\resources\\assets\\js\\components\\PopupMedias.vue"
  if (!module.hot.data) {
...
var _PopupMedias = __webpack_require__(0);

var _PopupMedias2 = _interopRequireDefault(_PopupMedias);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.component('popup-medias', _PopupMedias2.default);
    ...
    methods: {
        ...
        deleteImage: function deleteImage(id) {
            ...
            if (confirm('Вы уверены что хотите удалить картинку ?')) {
                $.post(__media.url.deleteMedia + "/" + id, {
                    '_token': __media.csrf,
                    '_method': "DELETE",
                    'id': id
                }, function () {
