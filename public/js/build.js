...
if (false) {(function () {  module.hot.accept()
  ...
  var id = "C:\\OpenServer\\domains\\rabota-x\\resources\\assets\\js\\components\\Medias.vue"
  if (!module.hot.data) {
...
var _Medias = __webpack_require__(0);

var _Medias2 = _interopRequireDefault(_Medias);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.component('medias', _Medias2.default);

__app = new _vue2.default({
    el: '#media-loop'
});
...
Dropzone.options.myDropzone = {
    ...
    init: function init() {
        this.on("complete", function (file) {
            $.getJSON(__media.getDownload + "/" + JSON.parse(file.xhr.response).id, function (image) {
...
exports.default = {
    ...
    methods: {
        getMedias: function getMedias() {
            $.getJSON(__media.getMedia, function (medias) {
                this.medias = medias;
            }.bind(this));
        },
    ...
    computed: {
        chunkedMedias: function chunkedMedias() {
